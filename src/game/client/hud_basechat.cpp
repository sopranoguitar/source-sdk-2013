...
CON_COMMAND(clear_chat, "Clear all chat output.")
{
	CBaseHudChat *pHUDChat = (CBaseHudChat *) gHUD.FindElement( "CHudChat" );
	if (pHUDChat)
	{
		pHUDChat->GetChatHistory()->SetText("");
		pHUDChat->GetChatHistory()->GotoTextEnd();
	}
}